...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>A</b>CV</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>CicloVittal</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/admin/logout" class="btn btn-block btn-danger">Sair</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/blog"><i class="fa fa-newspaper-o" style="font-size: 22px"></i> <span style="font-size: 16px; margin-left: 10px">Blog</span></a></li>
        <li><a href="/admin/galeria"><i class="fa fa-camera-retro" style="font-size: 22px"></i> <span style="font-size: 16px; margin-left: 10px">Galeria</span></a></li>
        <!-- <li class="treeview">
