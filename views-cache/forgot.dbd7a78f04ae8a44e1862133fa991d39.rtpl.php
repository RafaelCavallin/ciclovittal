...
<head>
  ...
  <title>CicloVittal</title>
      <link rel="icon" href="3505ciclo-logo-grd-footer.ico" type="image/x-icon" />

      <link rel="shortcut icon" href="3505ciclo-logo-grd-footer.ico" type="image/x-icon" />
        <style>
           body{margin:
                0;padding: 0;
           }
                                          ...
                                          <tr>
                                             <td style="border-collapse: collapse;">
                                                <h2><a style="display: inline-block; text-decoration:
                                                   ...
                                                   assunto nos clientes de e-mail!
                                                   ;)</span></a>
                                                </h2>
                                             </td>
                                          </tr>
                                             ...
                                             <td style="border-collapse:
                                                ...
                                                <div style="font-family: Arial;
                                                   ...
                                                   <div style="text-align:
                                                      center;"><br></div>
                                                   <div style="font-weight: bold">Olá <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>,</div>
                                                   <div style="text-align:
                                                      center;"><br></div>
                                                   <div style="text-align:
                                                      center;">Para redefinir a sua senha clique no botão abaixo:<span style="line-height: 0; display:
                              ...
                              <tr>
                                 <td style="border-collapse:
                                    ...
                                    <div style="font-family: Arial; text-align:
                                       ...
                                       <div><img src="http://i68.tinypic.com/fmhn2v.png" alt="Ciclo Vittal"></div>           
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                 ...
                                 <td style="border-collapse: collapse; font-family:
                                    ...
                                    <table width="100%" style="border-collapse: collapse; border-spacing:
                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="border-collapse: collapse;">
                                                <hr style="border-color: rgb(54,100,139);
                                                   border-style:
                                                   dashed;">
                                             </td>
                                          </tr>
                                                ...
                                                collapse;">
                                                 <div style="font-family: Arial;
                                                   ...
                                                   <a style="text-align: center;display:block;
                                                      color: rgb(255,255,255);" href="callto:(15) 99143-6145">(15) 99143-6145
                                                    </a>
                                                       <a style="text-align: center;display:block; color: rgb(255,255,255);" href="mailto:mekhetdesenvolvimento@gmail.com">
                                                       mekhetdesenvolvimento@gmail.com
                                                       </a>
                                                </div>
                                             </td>
                                          </tr>
