...
<head>
  ...
  <title>CicloVittalADM - Login</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Entre com usuário e senha para iniciar a sessão</p>

    <form action="/admin/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Usuário" name="deslogin">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Senha" name="despassword">
