...
<head>
	...
	<body>
		...
		<!-- onload="window.open('', '_self', '');"   DENTRO DA TAG BODY -->

		<div class="container" style="margin-top: 100px; border: 20px solid #ccc; padding: 50px; color: #36648B">
			<div class="text-center">
				...
				<div class="form-group">
					...
					<a href="javascript:fechar()" class="btn btn-danger">Fechar</a>
					<!-- <a href="javascript:window.close" class="btn btn-danger">Fechar</a> -->
					</form>
			</div>	
		</div>
